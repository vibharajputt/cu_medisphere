  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 20px 80px' }}>
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, #00b4b6 0%, #17b885 40%, #12c28e 100%)',
          ...
          return (
            <motion.button
              ...
              style={{
                ...
                background: isActive ? 'linear-gradient(135deg, #00b4b6, #17b885)' : 'transparent',
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <FiBell size={18} color={reminders.enabled ? '#00b4b6' : 'var(--text-muted, #94a3b8)'} />
                <div>
              ...
              {reminders.enabled && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#00b4b6', fontWeight: 600, fontSize: '0.82rem' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, #00b4b6, #17b885)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '1.2rem',
                  }}>
                    🥗
          ...
          >
            ...
            >
              ...
              <div style={{
                padding: '24px 28px 20px',
                borderBottom: '1px solid var(--border-color, #e2e8f0)',
                background: 'linear-gradient(135deg, rgba(4, 42, 89,0.04), rgba(4, 42, 89,0.01))',
              }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{
                    width: 40, height: 40, borderRadius: 'var(--radius-md, 10px)',
                    background: 'linear-gradient(135deg, #042a59, #818cf8)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '1.2rem',
                  }}>
                    🏃
...
function FreqChip({ active, label, emoji, icon }) {
  return (
    <div style={{
      ...
      fontSize: '0.76rem',
      fontWeight: 600,
      color: active ? '#00b4b6' : 'var(--text-muted, #94a3b8)',
