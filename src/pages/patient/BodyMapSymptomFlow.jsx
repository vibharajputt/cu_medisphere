...
export default function BodyMapSymptomFlow() {
    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        const backendBase = import.meta.env.VITE_API_URL 
          ...
          : 'https://medisphere-ke9x.onrender.com';
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      const text = dataObj.analysis || dataObj.reply || (typeof dataObj === 'string' ? dataObj : null);
      const model = dataObj.model || 'AstraMedX 2D Triage Engine v4.2';
