          ...
          {loading ? (
            ...
            <div style={{ display: 'grid', gap: '24px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
                ...
                {/* Exercise Card */}
                <div style={{ padding: '24px', borderRadius: '18px', background: 'linear-gradient(135deg, rgba(255,255,255,0.9), rgba(4, 42, 89,0.02))', border: '1px solid var(--border-color)', minHeight: '220px' }}>
